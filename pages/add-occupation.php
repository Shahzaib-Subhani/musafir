        ...
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0 pb-2 m-auto p-5 " style="width: 90% !important;">
            ...
            <form role="form" id="cityForm" class="w-100">
              ...
              <div class="mb-3">
                <input id="city" type="text" class="form-control" placeholder="Occupation Name">
              </div>
...
<script type="module">
 import {addCitiesCollection} from "./firebase/occupation.js";
  tableModuel.addCitiesCollection = addCitiesCollection;

  import {
    updateProfileStatus
  } from "./firebase/occupationFunc.js"
...
<script type="module" src="./firebase/occupation.js"></script>