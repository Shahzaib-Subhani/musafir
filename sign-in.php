<script>
  ...
  console.log(admin);
  if(admin !== null) window.location.href = "index.php?page=dashboard"
</script>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form role="form">
                    ...
                    <div class="text-center">
                      <button id="login" type="button" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div class="col-md-6" style="height: 100vh;">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto  z-index-0 ms-n6"  style="background-image:url('assets/img/curved-images/curved6.jpg');height:100vh"></div>
              </div>
            </div>
          </div>
        </div>
